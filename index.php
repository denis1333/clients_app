<?php
	...
	Согласно задания использовались только чистый php и mysql, без js. Из - за ограничености инструментов
	пришлось осуществлять работу с телефонами через textarea. Возможно, это не лучший вариант. Для хранения телефонов реализована связь многи ко многим.
	*/
?>
...
<body>
	...
	<?php
		/*
		С помощью скрытого инпута определяется из какой 
		формы пришел запрос
		*/
		switch ($_POST['type']) {
			case 'search':
